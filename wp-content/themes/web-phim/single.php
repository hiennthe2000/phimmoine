              ...
              <div class="row">
                <figure class="movie-detail-banner col-12">
                  ...
                  <div class="loading-video">
                    ...
                    <img class="loading" src="<?php echo get_template_directory_uri() ?>/images/loading.svg" alt="">
                  </div>
                  <?php
                  $link_movie = get_post_meta(get_the_ID(), 'link_movie', true);
                  ?>
                  <iframe src="<?php echo $link_movie; ?>" width="640" height="360" allow="autoplay; encrypted-media; fullscreen; picture-in-picture;" frameborder="0" allowfullscreen></iframe>
                </figure>
